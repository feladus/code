...
256-Dimensional SimCLR Pretraining and Fine-Tuning: Code for pretraining and fine-tuning SimCLR with a 256-dimensional representation.
2D SimCLR Pretraining and Fine-Tuning: Code for pretraining and fine-tuning SimCLR with a 2D representation.
DINO: Implementation of the DINO self-supervised learning model, with code for both pretraining and fine-tuning.
